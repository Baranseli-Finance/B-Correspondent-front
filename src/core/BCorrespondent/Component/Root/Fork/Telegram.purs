module BCorrespondent.Component.Root.Fork.Telegram (fork, init) where

import Prelude

import BCorrespondent.Component.Async (withAffjax)
...
loc = "BCorrespondent.Component.Root.Fork.Telegram:"
