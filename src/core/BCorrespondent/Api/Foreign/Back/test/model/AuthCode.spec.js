...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new BCorrespondentTagV100Commit9e7bfa7.AuthCode();
    });
    ...
    describe('AuthCode', function() {
        it('should create an instance of AuthCode', function() {
            // uncomment below and update the code to test AuthCode
            //var instance = new BCorrespondentTagV100Commit9e7bfa7.AuthCode();
            //expect(instance).to.be.a(BCorrespondentTagV100Commit9e7bfa7.AuthCode);
        });
