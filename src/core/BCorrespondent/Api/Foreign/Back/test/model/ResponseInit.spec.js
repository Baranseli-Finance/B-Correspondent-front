...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new BCorrespondentTagV100Commit9e7bfa7.ResponseInit();
    });
    ...
    describe('ResponseInit', function() {
        it('should create an instance of ResponseInit', function() {
            // uncomment below and update the code to test ResponseInit
            //var instance = new BCorrespondentTagV100Commit9e7bfa7.ResponseInit();
            //expect(instance).to.be.a(BCorrespondentTagV100Commit9e7bfa7.ResponseInit);
        });
