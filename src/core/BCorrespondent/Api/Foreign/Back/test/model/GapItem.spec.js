...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new BCorrespondentTagV100Commit9e7bfa7.GapItem();
    });
    ...
    describe('GapItem', function() {
        it('should create an instance of GapItem', function() {
            // uncomment below and update the code to test GapItem
            //var instance = new BCorrespondentTagV100Commit9e7bfa7.GapItem();
            //expect(instance).to.be.a(BCorrespondentTagV100Commit9e7bfa7.GapItem);
        });
