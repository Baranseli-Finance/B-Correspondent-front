...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new BCorrespondentTagV100Commit9e7bfa7.ResponseBool();
    });
    ...
    describe('ResponseBool', function() {
        it('should create an instance of ResponseBool', function() {
            // uncomment below and update the code to test ResponseBool
            //var instance = new BCorrespondentTagV100Commit9e7bfa7.ResponseBool();
            //expect(instance).to.be.a(BCorrespondentTagV100Commit9e7bfa7.ResponseBool);
        });
