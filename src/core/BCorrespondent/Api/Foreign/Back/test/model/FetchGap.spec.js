...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new BCorrespondentTagV100Commit9e7bfa7.FetchGap();
    });
    ...
    describe('FetchGap', function() {
        it('should create an instance of FetchGap', function() {
            // uncomment below and update the code to test FetchGap
            //var instance = new BCorrespondentTagV100Commit9e7bfa7.FetchGap();
            //expect(instance).to.be.a(BCorrespondentTagV100Commit9e7bfa7.FetchGap);
        });
