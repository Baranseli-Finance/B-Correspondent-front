...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://api.b-correspondent.app') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://api.b-correspondent.app
         */
    ...
    hostSettings() {
        return [{
                'url': "http://api.b-correspondent.app",
                'description': "No description provided",
            },
            {
                'url': "https://api.b-correspondent.app",
                'description': "No description provided",
            }
        ];
    }
